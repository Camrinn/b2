...
const SocialIcons = () => (
  <div className="flex space-x-6">
    ...
    <a href="https://www.linkedin.com/in/camrinneiss" target="_blank" rel="noopener noreferrer">
      <FontAwesomeIcon icon={faLinkedin} className="text-white text-2xl hover:opacity-75" />
    </a>
    <a href="https://www.instagram.com/camrinneiss/" target="_blank" rel="noopener noreferrer">
